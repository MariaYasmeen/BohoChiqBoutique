    ...
    return (
        ...
        <section className="text-gray-600 body-font mt-10 mb-10"  >
            <div className="container px-5 mx-auto mb-10" >
                <div className=" flex-wrap -m-4 text-center" style={{display:"flex", flexDirection:"row"}}>
                    <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                        <div className=" border-2 hover:shadow-purple-600 shadow-[inset_0_0_10px_rgba(0,0,0,0.6)] bg-gray-100 border-gray-300    px-4 py-3 rounded-xl"  >
                            <div className="text-purple-500  inline-block" viewBox="0 0 24 24">
                    ...
                    <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                        <div className=" border-2 hover:shad>
                    ...
                    <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                        <div className=" border-2 hover:sha">
            ...
            <div className="container mx-auto" >
                <div className="tab container mx-auto " >
                    <Tabs defaultIndex={0} className=" " >
                        <TabList className="md:flex md:space-x-8 bg-  grid grid-cols-2 text-center gap-4   md:justify-center mb-10 " style={{display:"flex", flexDirection:"row"}}>
                            <Tab>
               ...
               {product.map((item, index) => {
                const {title, price, imageURL, category, desc, date} = item;
return (
    <tbody className=''  >
